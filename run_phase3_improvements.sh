#!/bin/bash
# Phase 3 Improvements: Expanded Classical Grids + Kernel Caching + Quantum Features
# Builds on Phase 1 + Phase 2: All improvements enabled
# Expected improvements: +1-3% PR-AUC from expanded grids, faster re-runs from caching
