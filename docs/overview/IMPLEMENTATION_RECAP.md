...
- **`docs/planning/NEXT_STEPS_TO_IMPROVE_PERFORMANCE.md`:** Latest results table, experiment log, recommended commands, new pipeline features table, VQC ansatz comparison, Optuna usage, GPU notes.
...
| Docs / deps | `docs/planning/NEXT_STEPS_TO_IMPROVE_PERFORMANCE.md`, `requirements.txt`, `requirements-full.txt` |
