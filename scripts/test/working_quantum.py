#!/usr/bin/env python3
"""
Working quantum test - uses the correct modern Qiskit Runtime API
"""
...
def main():
    ...
    try:
        ...
        # Execute using the CORRECT modern API
        ...
        # Use the CORRECT modern API - Sampler with Session
        print("📤 Submitting job...")
        
        # Create session with backend
        session = Session(backend=backend)
        
        # Create sampler in the session
        ...
        print(f"❌ Error: {e}")
        print("\nIf you get a session error, try the simulator version instead.")

def run_simulator():
    """Run the same circuit on local simulator"""
    ...
    if bell_percentage > 90:
        print("   ✅ Perfect quantum entanglement!")
    else:
...
if __name__ == "__main__":
    ...
    print("1. Run on real quantum hardware")
    print("2. Run on local simulator")
