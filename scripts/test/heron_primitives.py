#!/usr/bin/env python3
"""
IBM Quantum Computer Test - Open Plan Compatible with Primitives
Uses the new primitives interface without sessions
"""
...
def main():
    print("🚀 IBM Quantum Computer Test - Primitives Interface")
    print("=" * 55)
    ...
    try:
        ...
        # Execute using primitives interface (open plan compatible)
        print(f"\n🚀 Running on {backend.name} using primitives...")
        ...
        # Use Sampler primitive directly with backend (no session for open plan)
        print("📤 Submitting job using Sampler primitive...")
        
        # Create sampler directly with backend - this should work with open plan
        ...
        print("  - Try using a simulator first to test the circuit")
