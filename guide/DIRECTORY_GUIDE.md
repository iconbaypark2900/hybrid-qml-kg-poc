...
- Project root: `/home/roc/quantumGlobalGroup/semantics/hybrid-qml-kg-poc`
...
├── scripts/                 # Runners, benchmarks, tests
├── COMMANDS.md              # Command cookbook
├── README.md                # Project overview & quickstart
├── requirements.txt         # Python dependencies
└── =1.0                     # Stray marker/version file (unused)
```
...
- `COMMANDS.md`: Command cookbook for common tasks, parameters, troubleshooting, and deployment.
- `requirements.txt`: Dependency pinning for compatible environment.
- `=1.0`: Stray/legacy marker; not used by the pipeline.
