...
**Expected improvement**: +5–15% relative (per IMPROVEMENTS_SUMMARY.md)
...
- `RESULTS_ANALYSIS_V2.md` -- Kernel separability bottleneck
- `IMPROVEMENTS_SUMMARY.md` -- Completed and planned improvements
